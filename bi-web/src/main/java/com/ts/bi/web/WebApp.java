...
@MapperScan("com.ts.bi.data.dao")
@ComponentScan(basePackages = "com.ts.bi.*")
...
public class WebApp {
    ...
    public static void match(String env){
        ...
        ENV[] ss = com.ts.bi.web.config.constant.ENV.values();
